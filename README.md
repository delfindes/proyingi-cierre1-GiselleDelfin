...
| ----------- | --------------------------------------------------------------------- | ------------------------- |
| Markdown    | [Para poner poner cosas como títulos, negritas, enlaces, listas, etc] | [A medias]                |
| Obsidian    | [Para edidar los archivos antes de enviarlos]                         | [Sí]                      |
| Git         | [Para enviar los comandos como git add ., git push, git commit, etc]  | [Sí]                      |
| GitHub      | [Es la pagina donde subi mi trabajo]                                  | [A medias]                |

## Cómo voy en el curso

- [x] [Aprender a entrar a las carpetas y a los archivos desde la terminal]
- [ ] [Aun no me sale tan bien pasar los archivos a github]
